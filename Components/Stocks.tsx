				...
				return (
					<View key={key} style={{ width: "100%" , alignItems: 'center'}}>
						...
						<View style={{ paddingLeft: 25, paddingRight: 25 }}>
							...
							<Text
                                numberOfLines={this.state.openedIndex === parseInt(key) ? 100 : 4}
								style={{ ...appStyles.text , fontFamily: "Neuron", fontSize: 16 }}
							>
								{item.text}
							</Text>
						</View>
                        <View style={{flexDirection: 'row', width: '100%' , justifyContent: 'space-between' , paddingLeft: 25, paddingRight: 25, marginTop: 10}}>
                        <TouchableOpacity
                        onPress={()=>{
                            this.setState({openedIndex: parseInt(key)});
                        }}>
                            <Image 
