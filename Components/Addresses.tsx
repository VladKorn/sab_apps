...
export const Addresses = (props: Props) => {
	...
	const addresses = authContext.user?.addresses || [];
	...
	return (
		<ScrollView>
			...
			>
				...
				>
					Если вы хотите изменить текущий или добавить новый адрес,
					просьба оставить заявку в форму ниже или позвонить нам
				</Text>
				<TouchableOpacity
					onPress={() => {
